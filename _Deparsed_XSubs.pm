...
sub _get_state_;
sub _get_volume_;
sub _insert_media_list_;
sub _media_list_count_;
sub _media_list_is_readonly_;
sub _media_list_lock;
sub _media_list_player_next_;
sub _media_list_player_previous_;
sub _media_list_unlock;
sub _media_parse_async_;
sub _parse_media_;
sub _pause;
sub _pause_list_;
sub _play;
sub _play_list_;
sub _release_;
sub _remove_media_list_index_;
sub _save_meta_;
sub _set_location;
sub _set_media;
sub _set_media_list_;
sub _set_meta_;
sub _set_mute_;
sub _set_volume_;
sub _stop;
